  ...
  return (
    <div className="relative w-1/4  mr-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-sm flex flex-col justify-between h-50">
      <div className="mb-6 text-left">
        <p className="text-gray-800 text-base leading-relaxed font-light font-family-founders">{body}</p>
      </div>
      ...
      <div className="flex items-center text-blue-500 text-sm">
        ...
        <span className="hover:text-blue-600 cursor-pointer transition-colors duration-200 font-family-mondwest">
          {footerText}
        </span>
      </div>
    </div>
